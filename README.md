...
衛星データ活用やGISデータの活用の学習として、高梁市の水田の消失について分析を行った。
...
4. **衛星画像を用いたダブルチェック**
    ...
    - 2025年の春夏の植生データから2025年の水田地点を推定。モデルの予測結果と比較し、作成した水田リスク消失予測マップの評価に用いた。
...
* **モデル精度と検証**: 春夏のNDVI画像の差分を利用して作成した水田マップを2025年時点での暫定的な正解とし、リスクマップとの重ね合わせにより、モデルが「消失リスク高」と判定したエリアは69%の一致率で水田消失を予測できていると分かった。
